 ...
 */
 ...
 (function($){
	 ...
	 $.fn.prepareChatContext = function(){
		...
		/*$.each(chat_app_obj.chatBoxCgArr, function(){
			if(this instanceof groupBox){
 ...
 chatApp = function( user_id, project_context){
	 ...
	 * Creating the chat box app
	 */
	this.dom.find('.cg_group_row').each(function(i){
		//self.chatBoxCgArr[$(this).data('group_id')] = new groupBox(self.u_id, $(this).data('group_id'));
	});
	 ...
	 */			
	 ...
	 /**
	  * Open a grioup chat box
	  */
	  
	  $('.cg_group_row').on('click',function(){
	 	var group_id  = $(this).data('group_id');
		self.chatBoxCgArr[group_id].maximize();
	 });
